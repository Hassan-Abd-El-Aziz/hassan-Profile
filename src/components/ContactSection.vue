    ...
    >
      <div>
        ...
        <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
          ...
          <div class="flex mb-10 items-center">
            ...
            >
              <img
                src="https://img.icons8.com/?size=100&id=78224&format=png&color=ffffff"
                alt="new-post"
                class="w-6"
              />
            </div>
          ...
          <div class="flex mb-10 items-center">
            ...
            >
              <img
                src="https://img.icons8.com/?size=100&id=62925&format=png&color=ffffff"
                alt="new-post"
                class="w-7"
              />
            </div>
      ...
      >
        <form class="flex flex-col p-2" data-aos="zoom-in-up">
          ...
          <button
            class="z-1 w-[100%!imprtant] px-6 md:px-7 py-3 rounded-full md:w-max sm:w-max flex justify-center text-white bg-primary border-2 border-transparent"
          >
            Send Message
          </button>
        </form>
